...
<main className="overflow-hidden text-black dark:text-white bg-white dark:bg-[#080808] ">
  <div className="h-fit flex w-screen overflow-hidden   text-white  " id="Home">
    <section className="w-full h-full px-2 lg:px-12 pt-4 flex flex-col">
       <div className="w-full p-2 border-[#ececec] border-dashed flex justify-between items-center rounded-lg relative z-40 flex-1 overflow-hidden ">
        <motion.h1
        initial={{
          opacity:0,
          y:20,
  ...
  <section className="w-screen h-fit p-4 mt-14 md:mt-20 lg:mt-28 overflow-x-hidden" id="About">
  ...
  <div className="flex flex-col lg:flex-row lg:pt-28">
    ...
    <p className="text-xl lg:text-2xl tracking-wide font-medium text-wrap">
      ...
      <h1 className="text-green-600 pt-6 text-lg md:text-xl lg:text-2xl">Education</h1>
      ...
      className="w-full h-[2px] bg-neutral-800 mb-2 text-xl font-semibold"></div>
       ...
       onClick={()=>toggleAccordion(dataItem.id)} key={dataItem.id}>
         <div className="flex flex-col md:text-lg lg:text-xl" key={dataItem.id}>
      ...
      {/*  */}
      <h1 className="text-green-600 pt-6 text-lg md:text-xl lg:text-2xl">Experiance</h1>
    ...
    {/*  */}
    {/*  */}
    <h1 className="text-green-600 pt-6 text-lg md:text-xl lg:text-2xl">Certificates</h1>
    {
        completeCrtData && completeCrtData.length > 0
        ?completeCrtData.map((dataItem)=>(
          <div className="space-y-2 md:text-lg lg:text-xl" key={dataItem.Id}>
             <div 
      ...
      <img src="https://media.licdn.com/dms/image/v2/D4D22AQFAxv_G28KQcg/feedshare-shrink_800/feedshare-shrink_800/0/1716906019555?e=1736985600&v=beta&t=bM-u-Ak9XzNgl9aR-MKr6h2kFvCUgZxQx9dO-laUz10" alt="" className="object-scale-down lg:min-w-[50vw]  rounded-md lg:rounded-lg lg:h-full pt-6 mx-auto  " />
...
<section className="w-screen h-fit p-4 " id="Skills"> 
  <div className="w-full h-[2px] bg-neutral-800"></div>
  <div className="flex flex-col lg:flex-row lg:pt-28">
    ...
    <div>
    <div className="p-4 pb-28 lg:pb-80 w-full lg:max-w-screen-md mx-auto place-self-start grid grid-cols-3 gap-4 ">
      ...
      <svg width="80px" height="68px" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"> <rect x="8" y="2" width="24" height="28" rx="2" fill="#2FB776"></rect> <path d="M8 23H32V28C32 29.1046 31.1046 30 30 30H10C8.89543 30 8 29.1046 8 28V23Z" fill="url(#paint0_linear_87_7712)"></path> <rect x="20" y="16" width="12" height="7" fill="#229C5B"></rect> <rect x="20" y="9" width="12" height="7" fill="#27AE68"></rect> <path d="M8 4C8 2.89543 8.89543 2 10 2H20V9H8V4Z" fill="#1D854F"></path> <rect x="8" y="9" width="12" height="7" fill="#197B43"></rect> <rect x="8" y="16" width="12" height="7" fill="#1B5B38"></rect> <path d="M8 12C8 10.3431 9.34315 9 11 9H17C18.6569 9 20 10.3431 20 12V24C20 25.6569 18.6569 27 17 27H8V12Z" fill="#000000" fillOpacity="0.3"></path> <rect y="7" width="18" height="18" rx="2" fill="url(#paint1_linear_87_7712)"></rect> <path d="M13 21L10.1821 15.9L12.8763 11H10.677L9.01375 14.1286L7.37801 11H5.10997L7.81787 15.9L5 21H7.19931L8.97251 17.6857L10.732 21H13Z" fill="white"></path> <defs> <linearGradient id="paint0_linear_87_7712" x1="8" y1="26.5" x2="32" y2="26.5" gradientUnits="userSpaceOnUse"> <stop stopColor="#163C27"></stop> <stop offset="1" stopColor="#2A6043"></stop> </linearGradient> <linearGradient id="paint1_linear_87_7712" x1="0" y1="16" x2="18" y2="16" gradientUnits="userSpaceOnUse"> <stop stopColor="#185A30"></stop> <stop offset="1" stopColor="#176F3D"></stop> </linearGradient> </defs> </g></svg>
      </div>
...
height:109,width:109
      ...
      <h1 className="pt-2 m">CyberSecurity Awerness</h1>
